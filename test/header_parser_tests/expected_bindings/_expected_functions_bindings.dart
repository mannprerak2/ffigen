...
typedef Native_func4 = ffi.Pointer<ffi.Void> Function(
    ...
    ffi.Double arg1,
    ffi.Pointer<ffi.Pointer<ffi.Pointer<ffi.Int32>>> arg2);
typedef shortHand = ffi.Pointer<
    ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.NativeFunction<b>>)>>;
typedef b = ffi.Void Function();
