...
class NativeLibrary {
  ...
  void func4(
    ffi.Pointer<ffi.NativeFunction<typedef1>> arg0,
  ) {
    return _func4(
      arg0,
    );
  ...
  late final _func4_ptr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Pointer<ffi.NativeFunction<typedef1>>)>>('func4');
  late final _func4 = _func4_ptr
      .asFunction<void Function(ffi.Pointer<ffi.NativeFunction<typedef1>>)>();
}

typedef typedef1 = ffi.Void Function(ffi.Handle);
